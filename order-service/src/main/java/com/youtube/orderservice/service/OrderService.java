...
import com.youtube.orderservice.mapper.OrderMapper;
...
public class OrderService {
    ...
    public OrderDTO saveOrder(OrderDTOfromFE orderDTOfromFE) {
        ...
        return OrderMapper.INSTANCE.mapOrdertoOrderDTO(orderRepo.save(ordertoSave));
    }

    private UserDTO fetchUserDetailsfromuserId(Integer userId) {
return restTemplate.getForObject("http://USER-INFORMATION-SERVICE/user/fetchUserById/"+userId, UserDTO.class);
    }
}
